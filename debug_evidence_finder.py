#!/usr/bin/env python3
"""
Debug script to test the evidence finder with real estate candidates.
"""
...
async def debug_evidence_finder():
    """Debug the evidence finder with real estate candidates."""
    print("=== Debugging Evidence Finder ===")
    
    # Test candidate with real estate behavioral reasons
    test_candidate = {
        'id': 'debug_test_1',
        'name': 'John Smith',
        ...
        'behavioral_data': {
            'behavioral_insight': 'Visited luxury real estate websites for Greenwich, Connecticut multiple times in the past month',
...
if __name__ == '__main__':
    asyncio.run(debug_evidence_finder())