...
interface KnowledgeGPTSimpleProps {
  apiUrl?: string;
  onSearchComplete?: (results: any) => void;
  className?: string;
}

const KnowledgeGPTSimple: React.FC<KnowledgeGPTSimpleProps> = ({
  ...
  return (
    <div className={`knowledge-gpt-simple ${className}`}>
      {/* Search Input */}
      <div className="search-section mb-6">
        ...
        {error && (
          <div className="mt-2 p-3 bg-red-100 border border-red-400 text-red-700 rounded flex justify-between items-center">
            <span>{error}</span>
            <button
              onClick={clearError}
...
export default KnowledgeGPTSimple; 