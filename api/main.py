...
Generate 1 unique, realistic search query. Be wildly creative and vary the approach, industry focus, geographic scope, company stage, and behavioral indicators. Return only the search query text, nothing else."""
    ...
    def _get_fallback_search(self, category: str, industry: str, location: str) -> Dict[str, Any]:
        ...
        fallback_queries = [
            ...
            f"Sales reps targeting {job_title}s at {company_size} {industry} companies {behavioral_signal}",
            f"Account executives looking for {industry} decision makers in {location} who are {behavioral_signal}",
            f"Business development managers seeking {job_title}s at companies {behavioral_signal}",
            f"Enterprise sales reps targeting {industry} executives {behavioral_signal} new solutions",
            f"Channel partners looking for {industry} companies in {location} {behavioral_signal}",
            f"Solution consultants seeking {job_title}s evaluating {industry} technology",
            f"Sales engineers targeting technical buyers at {industry} companies {behavioral_signal}",
            f"Inside sales teams prospecting {job_title}s at {company_size} firms {behavioral_signal}",
            f"Field sales reps looking for {industry} prospects in {location} {behavioral_signal}",
            f"Key account managers targeting {job_title}s at existing clients {behavioral_signal}",
            
            # Recruiters looking for talent
            f"Executive recruiters seeking {job_title}s in {industry} who might be {behavioral_signal}",
            f"Talent acquisition teams looking for passive {industry} candidates {behavioral_signal}",
            f"Headhunters targeting {job_title}s at {company_size} companies considering moves",
            f"Recruiting firms seeking {industry} professionals in {location} {behavioral_signal}",
            f"HR leaders looking for {job_title} candidates not actively job searching",
            f"Executive search consultants targeting {industry} leaders {behavioral_signal}",
            f"Technical recruiters seeking {job_title}s at companies {behavioral_signal}",
            f"Retained search firms looking for {industry} executives in {location}",
            f"Talent scouts identifying high-potential {job_title}s {behavioral_signal}",
            f"Recruitment consultants targeting passive {industry} candidates",
            
            # Finance/investment professionals looking for investors/LPs
            f"Private equity partners seeking LPs interested in {industry} investments",
            f"Venture capital firms targeting investors focused on {industry} startups",
            f"Hedge fund managers looking for accredited investors {behavioral_signal}",
            f"Asset managers seeking institutional investors for {industry} strategies",
            f"Investment bankers targeting {job_title}s at companies considering {behavioral_signal}",
            f"Fund managers looking for family offices investing in {industry}",
            f"Capital markets professionals seeking {industry} investors in {location}",
            f"Wealth managers targeting {job_title}s with investable assets {behavioral_signal}",
            f"Alternative investment firms seeking qualified purchasers {behavioral_signal}",
            f"Real estate funds targeting investors interested in {location} properties",
            
            # Professional services looking for clients
            f"Management consultants targeting {job_title}s at {industry} companies {behavioral_signal}",
            f"Strategy consultants seeking {industry} executives in {location} {behavioral_signal}",
            f"Technology consultants looking for {job_title}s evaluating digital transformation",
            f"Legal firms targeting {industry} companies in {location} {behavioral_signal}",
            f"Accounting firms seeking {job_title}s at {company_size} companies {behavioral_signal}",
            f"Tax advisors looking for {industry} executives {behavioral_signal} optimization",
            f"Risk consultants targeting {job_title}s at companies {behavioral_signal}",
            f"Compliance consultants seeking {industry} professionals {behavioral_signal}",
            f"Cybersecurity firms targeting {job_title}s at companies {behavioral_signal}",
            f"Executive coaches looking for {industry} leaders in {location} {behavioral_signal}",
            
            # B2B service providers looking for prospects
            f"Software vendors targeting {job_title}s at {industry} companies {behavioral_signal}",
            f"Cloud providers seeking {industry} decision makers in {location} {behavioral_signal}",
            f"Cybersecurity vendors looking for {job_title}s at companies {behavioral_signal}",
            f"Marketing agencies targeting {industry} executives {behavioral_signal} growth",
            f"PR firms seeking {job_title}s at {company_size} companies {behavioral_signal}",
            f"Event planners targeting {industry} professionals organizing conferences",
            f"Training companies looking for {job_title}s at companies {behavioral_signal}",
            f"Executive search firms targeting {industry} leaders {behavioral_signal}",
            f"Business intelligence vendors seeking {job_title}s {behavioral_signal} analytics",
            f"CRM vendors targeting sales leaders at {industry} companies {behavioral_signal}",
            
            # Investment/M&A professionals looking for targets
            f"Private equity firms seeking {industry} companies in {location} {behavioral_signal}",
            f"Strategic acquirers looking for {industry} targets {behavioral_signal}",
            f"Investment bankers seeking {job_title}s at companies considering exits",
            f"Corporate development teams targeting {industry} acquisition candidates",
            f"Venture capital firms looking for {industry} startups {behavioral_signal}",
            f"Growth equity investors seeking {company_size} {industry} companies {behavioral_signal}",
            f"Family offices looking for direct investment opportunities in {industry}",
            f"Sovereign wealth funds seeking {industry} assets in {location}",
            f"Pension funds targeting {industry} investment opportunities {behavioral_signal}",
            f"Endowments seeking alternative investments in {industry} {behavioral_signal}",
            
            # Networking and partnership development
            f"Business development professionals seeking {industry} partners in {location}",
            f"Partnership managers looking for {job_title}s at potential partner companies",
            f"Alliance managers targeting {industry} executives {behavioral_signal} partnerships",
            f"Channel managers seeking {job_title}s at {industry} companies {behavioral_signal}",
            f"Strategic partnership teams looking for {industry} collaborators {behavioral_signal}",
            f"Joint venture professionals targeting {job_title}s at companies {behavioral_signal}",
            f"Licensing executives seeking {industry} partners in {location} {behavioral_signal}",
            f"Corporate venture teams looking for {industry} startups {behavioral_signal}",
            f"Innovation managers seeking {job_title}s at companies {behavioral_signal}",
            f"Ecosystem development teams targeting {industry} participants {behavioral_signal}",
            
            # Weird but believable professional searches
            f"Executive recruiters looking for other recruiters who are {behavioral_signal}",
            f"Sales trainers seeking sales managers at {industry} companies {behavioral_signal}",
            f"Conference organizers targeting {job_title}s willing to speak at {industry} events",
            f"Podcast hosts looking for {industry} executives in {location} {behavioral_signal}",
            f"Book publishers seeking {job_title}s at companies {behavioral_signal} thought leadership",
            f"Documentary filmmakers targeting {industry} whistleblowers {behavioral_signal}",
            f"Journalists seeking {job_title}s at {industry} companies {behavioral_signal} interviews",
            f"Research firms looking for {industry} executives willing to participate in studies",
            f"Executive coaches targeting {job_title}s at companies {behavioral_signal} leadership development",
            f"Board search consultants seeking {industry} executives {behavioral_signal} board positions",
            f"Wealth managers targeting {job_title}s at companies going through {behavioral_signal}",
            f"Real estate brokers seeking {industry} executives {behavioral_signal} office relocations",
            f"Private jet brokers targeting {job_title}s at {company_size} companies {behavioral_signal}",
            f"Luxury car dealers seeking {industry} executives in {location} {behavioral_signal}",
            f"Art advisors targeting {job_title}s at companies {behavioral_signal} corporate collections",
            f"Wine investment advisors seeking {industry} executives {behavioral_signal} portfolio diversification",
            f"Yacht brokers targeting {job_title}s at {company_size} companies {behavioral_signal}",
            f"Private banking teams seeking {industry} executives {behavioral_signal} wealth management",
            f"Family office recruiters targeting {job_title}s at companies {behavioral_signal} career transitions",
            f"Executive protection firms seeking {industry} leaders {behavioral_signal} security services",
            f"Crisis communications firms targeting {job_title}s at companies {behavioral_signal}",
            f"Reputation management consultants seeking {industry} executives {behavioral_signal}",
            f"Political consultants targeting {job_title}s at {industry} companies {behavioral_signal} lobbying",
            f"Think tank researchers seeking {industry} executives willing to share insights on {behavioral_signal}",
            f"University professors looking for {job_title}s at companies {behavioral_signal} case studies",
            f"MBA programs targeting {industry} executives in {location} {behavioral_signal} guest lectures",
            f"Executive search firms seeking search consultants who are {behavioral_signal}",
            f"Headhunters looking for talent acquisition leaders {behavioral_signal} partnerships",
            f"Recruiting technology vendors targeting HR leaders {behavioral_signal} automation",
            f"Background check firms seeking HR professionals at companies {behavioral_signal}",
            f"Immigration lawyers targeting {job_title}s at {industry} companies {behavioral_signal} visa sponsorship",
            f"Tax attorneys seeking {industry} executives {behavioral_signal} international structures",
            f"Estate planning attorneys targeting {job_title}s at companies {behavioral_signal} succession planning",
            f"Divorce attorneys seeking {industry} executives in {location} {behavioral_signal} asset protection",
            f"Forensic accountants targeting {job_title}s at companies {behavioral_signal} investigations",
            f"Private investigators seeking {industry} executives {behavioral_signal} due diligence",
            f"Cybersecurity consultants targeting {job_title}s at companies recently {behavioral_signal}",
            f"Data recovery firms seeking IT leaders at {industry} companies {behavioral_signal}",
            f"Insurance brokers targeting {job_title}s at companies {behavioral_signal} risk management",
            f"Executive relocation services seeking {industry} leaders {behavioral_signal} moves to {location}",
            f"Corporate concierge services targeting {job_title}s at {company_size} companies {behavioral_signal}",
            f"Executive assistant staffing firms seeking {industry} leaders {behavioral_signal} support",
            f"Personal branding consultants targeting {job_title}s at companies {behavioral_signal}",
            f"LinkedIn ghostwriters seeking {industry} executives {behavioral_signal} thought leadership",
            f"Speaking bureaus targeting {job_title}s at companies {behavioral_signal} conference appearances",
            f"Award nomination consultants seeking {industry} executives {behavioral_signal} recognition",
            f"Executive photographers targeting {job_title}s at companies {behavioral_signal} headshots",
            f"Corporate event planners seeking {industry} executives {behavioral_signal} hospitality",
            f"Executive dining services targeting {job_title}s at companies {behavioral_signal} client entertainment"
